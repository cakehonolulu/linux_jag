...
/*
 * font.h - 8x8 monochrome ASCII bitmap font (glyphs 0x00-0x7F).
 *
 * Derived from font8x8 by Daniel Hepper <daniel@hepper.net>,
 * based on Marcel Sondaar / IBM public-domain VGA fonts.
 * Original license: Public Domain.
 * (https://github.com/dhepper/font8x8)
 *
 * Converted to bit7-leftmost row order for the marsfb console:
 * 8 bytes per glyph, top row first, MSB = leftmost pixel.
 */
#ifndef __MARS_FONT_H
#define __MARS_FONT_H

static const unsigned char textfont[128 * 8] = {
